...
$("#SecurityGuarding").hover(function() {
    $(".nav-menu-image").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Website_Images/Guarding.png');
    $("#solGuard").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/Colour sheilds/Guarding sheild.png');
}, function() {
    $("#solGuard").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/White icons without BG/Guarding sheild.png');
});

$("#Monitoring").hover(function() {
    $(".nav-menu-image").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/New_Website_Images/Monitoring_2.png');
    $("#solMonitoring").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/Colour sheilds/Monitoring sheild.png');
}, function() {
    $("#solMonitoring").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/White icons without BG/Monitoring white icon.png');
});

$("#KeyManagement").hover(function() {
    $(".nav-menu-image").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Website_Images/Frontline.png');
    $("#solKeys").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/Colour sheilds/Keyholding sheild.png');
}, function() {
    $("#solKeys").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/White icons without BG/Key management white icon.png');
});

$("#Engineering").hover(function() {
    $(".nav-menu-image").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Website_Images/Engineering_4.png');
    $("#solEng").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/Colour sheilds/Engineering sheild.png');
}, function() {
    $("#solEng").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/White icons without BG/Engineering white icon.png');
});

$("#Helpdesk").hover(function() {
    $(".nav-menu-image").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Website_Images/Helpdesk.png');
    $("#solHelp").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/Colour sheilds/Helpdesk sheild.png');
}, function() {
    $("#solHelp").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/White icons without BG/Helpdesk white icon.png');
});

$("#ProfessionalServices").hover(function() {
    $(".nav-menu-image").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Website_Images/Professional_3.png');
    $("#solProf").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/Colour sheilds/Professional sheild.png');
}, function() {
    $("#solProf").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Widgets/White icons without BG/Professional sheild white icon.png');
});
...
$("#about").click(function() {
    ...
    if(open == 'block') {
        ...
        $(this).addClass('highlighted-text');
        $(this).find('div').addClass('highlighted-underline');
        $(".nav-menu-image").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/New_Website_Images/Lion_Head_Cut.png');
        $(".nav-about").toggle();
    }
    else {
        $(this).addClass('highlighted-text');
...
$("#Quality").mouseover(function() {
    $(".nav-menu-image").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Website_Images/Car_With_Logo.png');
});

$("#Accreditation").mouseover(function() {
    $(".nav-menu-image").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Website_Images/Accreditations.png');
});

$("#CSR").mouseover(function() {
    $(".nav-menu-image").attr("src", 'https://samson-static-1319.s3.amazonaws.com/images/Website_Images/Rainbow_No_BG.png');
});
